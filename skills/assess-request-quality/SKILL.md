...
- **"inability to define what we expect"** — "Definition of done / exit criteria / requirements / expectations … are all about our inability to define what exactly we expect." ([How Micro Is Your Tasking?](https://www.yegor256.com/2017/11/28/microtasking.html)) — license for the skill's core thesis.
